...
export const createResultFormSchema = z.object({
    ...
    serviceResultDoor: z.number().optional(),
    serviceResultDoorLocks: z.number().optional(),
    serviceResultEntry: z.number().optional(),
    serviceResultWall: z.number().optional(),
    serviceResultFloor: z.number().optional(),
    serviceResultLock: z.number().optional(),
    ...
    serviceResultAge: z.number().optional(),
    serviceResultHeight: z.number().optional(),
    serviceResultWeight: z.number().optional(),
