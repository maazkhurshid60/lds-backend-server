...
const toggleServerHandler = async (req, res) => {
    ...
    if (shutdown === true) {
        ...
        (0, child_process_1.exec)('pm2 restart your-server-process-name', (err, stdout, stderr) => {
            if (err) {
...
exports.default = toggleServerHandler;
