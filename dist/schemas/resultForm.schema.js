...
exports.createResultFormSchema = zod_1.z.object({
    ...
    serviceResultDoor: zod_1.z.number().optional(),
    serviceResultDoorLocks: zod_1.z.number().optional(),
    serviceResultEntry: zod_1.z.number().optional(),
    serviceResultWall: zod_1.z.number().optional(),
    serviceResultFloor: zod_1.z.number().optional(),
    serviceResultLock: zod_1.z.number().optional(),
    ...
    serviceResultAge: zod_1.z.number().optional(),
    serviceResultHeight: zod_1.z.number().optional(),
    serviceResultWeight: zod_1.z.number().optional(),
